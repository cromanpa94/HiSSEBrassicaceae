...
##HiSSE analyses  
  ...
  models<-list(b1,b2,b3,b4,h1,h2,h3,h4,h1_ND,h5,h6, cid2,cid4)
  ...
  AIC=c(b1$AIC,b2$AIC,b3$AIC,b4$AIC,h1$AIC,h2$AIC,h3$AIC,h4$AIC,n4_nd$AIC,h5$AIC,h6$AIC,cid2$AIC,
        cid4$AIC))
...
##Stebbins
load("Script_ploidy_Jan28.RData")
tree2
